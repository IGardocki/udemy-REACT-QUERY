...
export function UserProfile() {
  ...
  // takes first item in pendingData array
  // we know theres only one mutation that matches filter
    ...
    <Flex minH="84vh" textAlign="center" justify="center">
      <Stack spacing={8} mx="auto" w="xl" py={12} px={6}>
        ...
        <Stack textAlign="center">
          <Heading>Your information: {pendingUser ? pendingUser.name : user?.name}</Heading>
        </Stack>
